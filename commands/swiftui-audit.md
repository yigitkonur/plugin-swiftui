...
---
Audit the macOS SwiftUI codebase at: **${ARGUMENTS:-.}**

Relevance scan (which of the 28 domain auditors actually apply here):
!`python3 "${CLAUDE_PLUGIN_ROOT}/scripts/audit-scan.py" "${ARGUMENTS:-.}" 2>/dev/null || echo '{"error":"audit-scan unavailable — is this a Swift project?"}'`
