...
- **WWDC23 — "Build programmatic UI with Xcode Previews" (session 10252).** The `#Preview` macro + `@Previewable` rationale. https://developer.apple.com/videos/play/wwdc2023/10252 — accessed 2026-06-07.
