...
restated here — they live in `<swiftui-plugin-root>/references/_shared/floors-master.md` (the single source
...
Confirm any floor against `<swiftui-plugin-root>/references/_shared/floors-master.md`; verify any uncertain
symbol via Sosumi (`<swiftui-plugin-root>/references/_shared/sosumi-reference.md`) and via `swiftui-ctx
...
`<swiftui-plugin-root>/references/_shared/hallucination-blacklist.md`). A `swiftui-ctx lookup
