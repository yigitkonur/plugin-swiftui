...
`<swiftui-plugin-root>/references/_shared/floors-master.md`. The **practice** half (the canonical shape +
...
2. **What's the canonical *shape*?** Run `bash <swiftui-plugin-root>/scripts/swiftui-ctx lookup <api> --json`
