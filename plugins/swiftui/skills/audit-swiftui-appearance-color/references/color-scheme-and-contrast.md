...
Floor values: `<swiftui-plugin-root>/references/_shared/floors-master.md` (read, never restate).
...
`<swiftui-plugin-root>/references/_shared/cross-ref-graph.md` (appearance-color ↔ accessibility:
