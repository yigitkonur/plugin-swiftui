...
`<swiftui-plugin-root>/references/_shared/sosumi-reference.md`; this file is the appearance-specific *map*
of which pages to fetch. Floor values live in `<swiftui-plugin-root>/references/_shared/floors-master.md`.
...
2. **Is it deprecated, and when?** For ac-03/ac-04 run `bash <swiftui-plugin-root>/scripts/swiftui-ctx
