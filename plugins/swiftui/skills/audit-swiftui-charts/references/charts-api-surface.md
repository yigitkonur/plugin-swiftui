...
they live in `<swiftui-plugin-root>/references/_shared/floors-master.md` (the single source of
...
`<swiftui-plugin-root>/references/_shared/hallucination-blacklist.md`; the charts-specific ❌→✅ this skill
applies:
