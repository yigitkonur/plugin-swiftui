...
and the JSON-404 caveat is `<swiftui-plugin-root>/references/_shared/sosumi-reference.md`; this file is the
charts-specific *map* of which pages to fetch. Floor values live in
`<swiftui-plugin-root>/references/_shared/floors-master.md`. The practice corpus (consensus shapes +
