...
restated here — it lives in `<swiftui-plugin-root>/references/_shared/macos-arm-gating.md`, and floor
values live in `<swiftui-plugin-root>/references/_shared/floors-master.md`. This file adds the
...
iOS-only symbol — see `<swiftui-plugin-root>/references/_shared/macos-arm-gating.md` §2. This skill
...
`<swiftui-plugin-root>/references/_shared/macos-arm-gating.md`, a wrong-arm gate is a gating finding,
**not** a hallucination.
...
- Floor values + gating rule: `<swiftui-plugin-root>/references/_shared/floors-master.md` and
  `<swiftui-plugin-root>/references/_shared/macos-arm-gating.md` (toolkit-internal, both Apple-sourced
