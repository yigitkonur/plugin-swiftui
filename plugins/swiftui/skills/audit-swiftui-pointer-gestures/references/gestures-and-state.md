...
`<swiftui-plugin-root>/references/_shared/floors-master.md`. The deprecated-rename rows are in
`<swiftui-plugin-root>/references/_shared/hallucination-blacklist.md`. The ✅ shape is the swiftui-ctx
