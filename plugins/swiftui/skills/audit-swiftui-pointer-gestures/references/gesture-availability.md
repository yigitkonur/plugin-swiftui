...
**single shared copy** in `<swiftui-plugin-root>/references/_shared/macos-arm-gating.md` — read it, do not
restate it here. Floor *values* live in `<swiftui-plugin-root>/references/_shared/floors-master.md`.
...
shared `<swiftui-plugin-root>/references/_shared/macos-arm-gating.md`. Note `pointerStyle` has **no iOS
...
`<swiftui-plugin-root>/references/_shared/macos-arm-gating.md` — not restated here.
