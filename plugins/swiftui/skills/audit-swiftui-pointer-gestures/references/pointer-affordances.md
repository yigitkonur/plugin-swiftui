...
`<swiftui-plugin-root>/references/_shared/floors-master.md`. The invented/stale case names are in
`<swiftui-plugin-root>/references/_shared/hallucination-blacklist.md`. The canonical ✅ shape is the
