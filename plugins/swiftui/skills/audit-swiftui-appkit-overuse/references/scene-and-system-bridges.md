...
`<swiftui-plugin-root>/references/_shared/floors-master.md` (`MenuBarExtra` 13, `fileImporter` 11,
`Transferable`/`.draggable` 13). Fetch protocol + paths: `references/source-directory.md` +
`<swiftui-plugin-root>/references/_shared/sosumi-reference.md`. CLI contract:
