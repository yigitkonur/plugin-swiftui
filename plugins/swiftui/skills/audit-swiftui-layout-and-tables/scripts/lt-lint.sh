...
#
# Rules for this skill live in:   ../lint/grep-tells.tsv       (tier 1 — flat grep tells: lt-01..lt-08)
#                                 ../lint/ast-grep/*.yml       (tier 2 — structural: lt-01 frame-absence,
#                                                               lt-04 Table-without-sortOrder)
