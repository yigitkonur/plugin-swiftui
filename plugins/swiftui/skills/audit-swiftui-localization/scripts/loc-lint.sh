#!/usr/bin/env bash
# loc-lint.sh — thin pointer. This skill has no bespoke lint script; detection runs through the toolkit's
# ONE shared hybrid lint engine fed declarative rule files (the pattern every audit skill inherits).
#
