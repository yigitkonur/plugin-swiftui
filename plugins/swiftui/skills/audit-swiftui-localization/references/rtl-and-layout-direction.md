...
direction. Floor values: `<swiftui-plugin-root>/references/_shared/floors-master.md`. Verify symbols via
Sosumi (`<swiftui-plugin-root>/references/_shared/sosumi-reference.md`).
