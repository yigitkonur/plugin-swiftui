...
`<swiftui-plugin-root>/references/_shared/sosumi-reference.md`; this file is the scenes-specific *map* of
which pages to fetch. Floor *values* live in `<swiftui-plugin-root>/references/_shared/floors-master.md`.
