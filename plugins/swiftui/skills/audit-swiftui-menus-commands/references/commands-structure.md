...
`<swiftui-plugin-root>/references/_shared/floors-master.md`. This file carries the structure, the
...
- Practice — `swiftui-ctx lookup CommandMenu` / `CommandGroup` (consensus `(replacing:)` 56% / `(after:)`
  ...
  2026-06-07 (`<swiftui-plugin-root>/references/_shared/swiftui-ctx-reference.md`).
