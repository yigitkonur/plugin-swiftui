...
```bash
bash <swiftui-plugin-root>/scripts/swiftui-ctx lookup Observable --json   # introduced_macos 14.0, recommended ex_44cfa1bff8
bash <swiftui-plugin-root>/scripts/swiftui-ctx file ex_44cfa1bff8 --smart # @Observable @MainActor final class, live from GitHub
```
