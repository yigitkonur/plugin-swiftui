...
`<swiftui-plugin-root>/references/_shared/sosumi-reference.md`; this file is the currency-specific *map*
...
`swiftui-ctx` (`lookup`/`deprecated`) per `<swiftui-plugin-root>/references/_shared/swiftui-ctx-reference.md`.
