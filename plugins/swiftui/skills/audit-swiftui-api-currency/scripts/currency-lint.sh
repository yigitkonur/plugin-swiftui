#!/usr/bin/env bash
# currency-lint.sh — thin pointer. The toolkit ships ONE shared hybrid lint engine fed declarative rule
# files; every audit skill inherits it. There is no bespoke script here.
#
