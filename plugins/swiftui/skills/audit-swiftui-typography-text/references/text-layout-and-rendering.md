...
`<swiftui-plugin-root>/references/_shared/floors-master.md`; the macOS-arm gating rule is
`<swiftui-plugin-root>/references/_shared/macos-arm-gating.md` — read, never restate.
