...
description: Build or revise a production macOS SwiftUI app using native scenes, state, commands, settings, and current platform conventions.
---
...
`bash <swiftui-plugin-root>/scripts/macos-swiftui-lint.sh <files-or-dir>`. The full 67-rule list
