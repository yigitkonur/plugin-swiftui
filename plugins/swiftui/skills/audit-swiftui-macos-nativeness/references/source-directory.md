...
`<swiftui-plugin-root>/references/_shared/sosumi-reference.md`; this file is the nativeness-specific *map*
of which pages to fetch. Floor values live in
`<swiftui-plugin-root>/references/_shared/floors-master.md`; the practice-shape CLI is
...
- Floors re-confirmed against `<swiftui-plugin-root>/references/_shared/floors-master.md` the same day;
