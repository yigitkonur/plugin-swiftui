...
> `<swiftui-plugin-root>/references/_shared/floors-master.md` **corrects** `focusable`/`focused`/
...
> label). Per `<swiftui-plugin-root>/references/_shared/cross-ref-graph.md` this is intentional —
