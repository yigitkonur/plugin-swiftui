...
permalinked example) comes from `<swiftui-plugin-root>/references/_shared/swiftui-ctx-reference.md`. Floor
values live in `<swiftui-plugin-root>/references/_shared/floors-master.md`.
...
- Practice corpus contract: `<swiftui-plugin-root>/references/_shared/swiftui-ctx-reference.md`.
