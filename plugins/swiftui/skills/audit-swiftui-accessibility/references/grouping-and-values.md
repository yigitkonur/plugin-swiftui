...
and driving a sane VoiceOver reading order. Floors in `<swiftui-plugin-root>/references/_shared/floors-master.md`.
For canonical shapes run `bash <swiftui-plugin-root>/scripts/swiftui-ctx lookup <api> --json`.
