...
descriptor. Floor *values* live in `<swiftui-plugin-root>/references/_shared/floors-master.md`. `Path` and
...
collapse it into the a11y skill. (See `<swiftui-plugin-root>/references/_shared/cross-ref-graph.md`:
