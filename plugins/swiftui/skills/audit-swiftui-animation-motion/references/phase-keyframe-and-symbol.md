...
values are the reconciled truth in `<swiftui-plugin-root>/references/_shared/floors-master.md`.
...
(`<swiftui-plugin-root>/references/_shared/macos-arm-gating.md`); (b) an SF Symbol is animated by hand
...
- Floors: `<swiftui-plugin-root>/references/_shared/floors-master.md` (Apple-sourced via Sosumi, 2026-06-07).
